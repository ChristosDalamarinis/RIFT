...
WINDOW_WIDTH = 1200
WINDOW_HEIGHT = 900
BACKGROUND_COLOR = [-0.1 , -0.1, -0.1]  # Black background = [-1, -1, -1] Gray = [-0.5 , -0.5, -0.5]
REFRESH_RATE = 60 # Hz - set to your monitor's actual refresh rate NOTE: 120 Hz WORKS GOOD
...
if ENABLE_NINE_OCLOCK_FLICKER and len (flicker_switches) > 1:
    ...
    actual_flicker_frequency = 1.0 / (2 * mean_switch_interval)  # Divide by 2 for on-off cycle
    print(f"\n{'=*70'}")
...
# this script takes solves the bugs of "t2.py" 
